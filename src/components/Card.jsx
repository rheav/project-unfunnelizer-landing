...
const Card = ({ video, children }) => {
  return (
    <div className="w-full h-full my-0 mx-auto bg-gradient-to-b from-zinc-50 to-slate-50 rounded-xl z-1 border-solid border-[1px] border-gray-200 drop-shadow-sm transition-all duration-500 hover:-translate-y-3 hover:drop-shadow-xl hover:border-gray-300 cursor-pointer">
      ...
      <div className=" pb-8 px-4 font-thin text-xl text-center">{children}</div>
    </div>
  );
};
