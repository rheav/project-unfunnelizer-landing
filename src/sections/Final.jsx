		...
		<section className="bg-white dark:bg-gray-900 py-12">
			<div className="px-4 mx-auto max-w-screen-xl text-center lg:px-12">
				<h2 className="mb-12 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-6xl lg:text-6xl dark:text-white">
					E o (às vezes) poderoso (demais)
					<span className="text-transparent  bg-clip-text bg-gradient-to-r from-startHot to-endHot"> bruteMode</span>
				</h2>
				...
				<h2 className="my-12 text-3xl font-extrabold tracking-tight leading-none text-gray-900 md:text-4xl lg:text-6xl dark:text-white">
					Esteja vários passos<span className="text-transparent  bg-clip-text bg-gradient-to-r from-startCold to-endCold"> à frente</span> da sua
					<span className="text-transparent  bg-clip-text bg-gradient-to-r from-startHot to-endHot"> concorrência</span>
				</h2>
				<DownloadButton />
			</div>
		</section>
